...
static int hyundai_community_long_rx_hook(CAN_FIFOMailBox_TypeDef *to_push) {

  bool valid;
  int addr = GET_ADDR(to_push);
  int bus = GET_BUS(to_push);

  valid = addr_safety_check(to_push, hyundai_community_long_rx_checks, HYUNDAI_COMMUNITY_LONG_RX_CHECK_LEN,
...
static int hyundai_community_long_tx_hook(CAN_FIFOMailBox_TypeDef *to_send) {
...
static int hyundai_community_long_fwd_hook(int bus_num, CAN_FIFOMailBox_TypeDef *to_fwd) {
...
const safety_hooks hyundai_community_long_hooks = {
  ...
  .rx = hyundai_community_long_rx_hook,
  .tx = hyundai_community_long_tx_hook,
  .tx_lin = nooutput_tx_lin_hook,
  .fwd = hyundai_community_long_fwd_hook,
