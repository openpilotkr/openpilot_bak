  ...
  for app in installed.keys():
    ...
    if h2 is None or h1 != h2:
      ...
      if app == "com.phillit.akeyboard":
        ...
        system("cp -f /data/openpilot/selfdrive/assets/addon/param/akeyboard/*.xml /data/data/com.phillit.akeyboard/shared_prefs/")
        system("cp -rf /data/openpilot/selfdrive/assets/addon/param/akeyboard/databases /data/data/com.phillit.akeyboard/")
        time.sleep(1)
        system("am start com.phillit.akeyboard/rcs.akbd.imguide.ImGuideActivity")
        time.sleep(3)
        system("reboot")
