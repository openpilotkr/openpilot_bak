...
static void update_state(UIState *s) {
  ...
  if (sm.updated("carState")) {
    ...
    scene.tpmsPressureFl = cs_data.getTpms.fl();
    scene.tpmsPressureFr = cs_data.getTpms.fr();
    scene.tpmsPressureRl = cs_data.getTpms.rl();
    scene.tpmsPressureRr = cs_data.getTpms.rr();
