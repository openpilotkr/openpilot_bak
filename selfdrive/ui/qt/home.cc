...
void HomeWindow::mousePressEvent(QMouseEvent* e) {
  // OPKR add map
  if (QUIState::ui_state.scene.started && map_overlay_btn.contains(e->pos())) {
  ...
  if (QUIState::ui_state.scene.started && !sidebar->isVisible() && !QUIState::ui_state.scene.map_on_top && map_btn.contains(e->pos()) && !QUIState::ui_state.scene.mapbox_running) {
  ...
  if (QUIState::ui_state.scene.started && !sidebar->isVisible() && !QUIState::ui_state.scene.map_on_top && mapbox_btn.contains(e->pos()) && QUIState::ui_state.scene.mapbox_running) {
  ...
  if (QUIState::ui_state.scene.started && QUIState::ui_state.scene.map_is_running && map_return_btn.contains(e->pos()) && !QUIState::ui_state.scene.mapbox_running) {
  ...
  // OPKR REC
  if (QUIState::ui_state.scene.started && !sidebar->isVisible() && !QUIState::ui_state.scene.map_on_top && !QUIState::ui_state.scene.comma_stock_ui && rec_btn.contains(e->pos()) && !QUIState::ui_state.scene.mapbox_running) {
    QUIState::ui_state.scene.touched = true;
    return;
  }
  // Laneless mode
  if (QUIState::ui_state.scene.started && !sidebar->isVisible() && !QUIState::ui_state.scene.map_on_top && QUIState::ui_state.scene.end_to_end && !QUIState::ui_state.scene.comma_stock_ui && laneless_btn.contains(e->pos()) && !QUIState::ui_state.scene.mapbox_running) {
  ...
  // Monitoring mode
  if (QUIState::ui_state.scene.started && !sidebar->isVisible() && !QUIState::ui_state.scene.map_on_top && monitoring_btn.contains(e->pos()) && !QUIState::ui_state.scene.mapbox_running) {
  ...
  // Stock UI Toggle
  if (QUIState::ui_state.scene.started && !sidebar->isVisible() && !QUIState::ui_state.scene.map_on_top && stockui_btn.contains(e->pos())) {
  ...
  // LiveTune UI Toggle
  if (QUIState::ui_state.scene.started && !sidebar->isVisible() && !QUIState::ui_state.scene.map_on_top && tuneui_btn.contains(e->pos()) && !QUIState::ui_state.scene.mapbox_running) {
  ...
  if (QUIState::ui_state.scene.started && !sidebar->isVisible() && !QUIState::ui_state.scene.map_on_top && speedlimit_btn.contains(e->pos())) {
  ...
  if (QUIState::ui_state.scene.live_tune_panel_enable) {
    if (QUIState::ui_state.scene.started && !sidebar->isVisible() && !QUIState::ui_state.scene.map_on_top && livetunepanel_left_btn.contains(e->pos())) {
    ...
    if (QUIState::ui_state.scene.started && !sidebar->isVisible() && !QUIState::ui_state.scene.map_on_top && livetunepanel_right_btn.contains(e->pos())) {
      if (QUIState::ui_state.scene.live_tune_panel_list == 0) {
        QUIState::ui_state.scene.cameraOffset = QUIState::ui_state.scene.cameraOffset + 5;
        if (QUIState::ui_state.scene.cameraOffset >= 1000) QUIState::ui_state.scene.cameraOffset = 1000;
        QString value = QString::number(QUIState::ui_state.scene.cameraOffset);
    ...
    if (QUIState::ui_state.scene.started && !sidebar->isVisible() && !QUIState::ui_state.scene.map_on_top && livetunepanel_left_above_btn.contains(e->pos())) {
    ...
    if (QUIState::ui_state.scene.started && !sidebar->isVisible() && !QUIState::ui_state.scene.map_on_top && livetunepanel_right_above_btn.contains(e->pos())) {
      QUIState::ui_state.scene.live_tune_panel_list = QUIState::ui_state.scene.live_tune_panel_list + 1;
