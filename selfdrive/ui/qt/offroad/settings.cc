...
UserPanel::UserPanel(QWidget* parent) : QWidget(parent) {
  ...
  QObject::connect(open_settings_btn, &ButtonControl::clicked, this, &SettingsWindow::closeSettings);
  ...
  QObject::connect(softkey_btn, &ButtonControl::clicked, this, &SettingsWindow::closeSettings);
  ...
  QObject::connect(mixplorer_btn, &ButtonControl::clicked, this, &SettingsWindow::closeSettings);
