...
SoftwarePanel::SoftwarePanel(QWidget* parent) : ListWidget(parent) {
  ...
  auto gitPullBtn = new ButtonControl("Git Pull", "RUN");
  connect(gitPullBtn, &ButtonControl::clicked, [=]() {
    if (ConfirmationDialog::confirm("Do you want to run Git Pull? This will execute git pull command and reboot your device anyway.", this)) {
      Params().putBool("DoGitPull", true);
    }
  });
  ...
  QWidget *widgets[] = {versionLbl, lastUpdateLbl, updateBtn, gitBranchLbl, gitCommitLbl, osVersionLbl, gitPullBtn, uninstallBtn};
...
QWidget * network_panel(QWidget * parent) {
  ...
  list->addItem(new PrebuiltToggle());
  list->addItem(new CarSelectCombo());
