...
static void draw_laneless_button(UIState *s) {
  ...
  if (true) {
    nvgBeginPath(s->vg);
    nvgMoveTo(s->vg, btn_xc1-10, btn_yc-60);
    nvgLineTo(s->vg, btn_xc1-15, btn_yc-60);
    nvgLineTo(s->vg, btn_xc1-30, btn_yc-5);
    nvgLineTo(s->vg, btn_xc1-25, btn_yc-5);
    nvgClosePath(s->vg);
    nvgFillColor(s->vg, nvgRGBA(0,255,0,150));
    nvgFill(s->vg);
    nvgBeginPath(s->vg);
    nvgMoveTo(s->vg, btn_xc1-25, btn_yc+5);
    nvgLineTo(s->vg, btn_xc1-30, btn_yc+5);
    nvgLineTo(s->vg, btn_xc1-45, btn_yc+60);
    nvgLineTo(s->vg, btn_xc1-40, btn_yc+60);
    nvgClosePath(s->vg);
    nvgFillColor(s->vg, nvgRGBA(0,255,0,150));
    nvgFill(s->vg);
    nvgBeginPath(s->vg);
