...
HYBRID_CAR = set([CAR.KIA_OPTIMA_H, CAR.IONIQ_PHEV, CAR.ELANTRA_HEV_2021, CAR.KIA_NIRO_HEV, CAR.KIA_NIRO_HEV_2021, CAR.SONATA_HYBRID, CAR.KONA_HEV])  # these cars use a different gas signal
...
DBC = {
  CAR.ELANTRA: dbc_dict('hyundai_kia_generic', 'hyundai_kia_mando_front_radar'),
  CAR.ELANTRA_2021: dbc_dict('hyundai_kia_generic', 'hyundai_kia_mando_front_radar'),
  CAR.ELANTRA_HEV_2021: dbc_dict('hyundai_kia_generic', 'hyundai_kia_mando_front_radar'),
  CAR.ELANTRA_GT_I30: dbc_dict('hyundai_kia_generic', 'hyundai_kia_mando_front_radar'),
  CAR.GENESIS_G70: dbc_dict('hyundai_kia_generic', 'hyundai_kia_mando_front_radar'),
  CAR.GENESIS_G80: dbc_dict('hyundai_kia_generic', 'hyundai_kia_mando_front_radar'),
  CAR.GENESIS_G90: dbc_dict('hyundai_kia_generic', 'hyundai_kia_mando_front_radar'),
  CAR.HYUNDAI_GENESIS: dbc_dict('hyundai_kia_generic', 'hyundai_kia_mando_front_radar'),
  CAR.IONIQ_PHEV: dbc_dict('hyundai_kia_generic', 'hyundai_kia_mando_front_radar'),
  CAR.IONIQ_EV_2020: dbc_dict('hyundai_kia_generic', 'hyundai_kia_mando_front_radar'),
  CAR.IONIQ_EV_LTD: dbc_dict('hyundai_kia_generic', 'hyundai_kia_mando_front_radar'),
  CAR.IONIQ: dbc_dict('hyundai_kia_generic', 'hyundai_kia_mando_front_radar'),
  CAR.KIA_FORTE: dbc_dict('hyundai_kia_generic', 'hyundai_kia_mando_front_radar'),
  CAR.KIA_K5_2021: dbc_dict('hyundai_kia_generic', 'hyundai_kia_mando_front_radar'),
  ...
  CAR.KIA_OPTIMA: dbc_dict('hyundai_kia_generic', 'hyundai_kia_mando_front_radar'),
  CAR.KIA_OPTIMA_H: dbc_dict('hyundai_kia_generic', 'hyundai_kia_mando_front_radar'),
  CAR.KIA_SELTOS: dbc_dict('hyundai_kia_generic', 'hyundai_kia_mando_front_radar'),
  CAR.KIA_SORENTO: dbc_dict('hyundai_kia_generic', 'hyundai_kia_mando_front_radar'), # Has 0x5XX messages, but different format
  CAR.KIA_STINGER: dbc_dict('hyundai_kia_generic', 'hyundai_kia_mando_front_radar'),
  CAR.KONA: dbc_dict('hyundai_kia_generic', 'hyundai_kia_mando_front_radar'),
  CAR.KONA_EV: dbc_dict('hyundai_kia_generic', 'hyundai_kia_mando_front_radar'),
  CAR.KONA_HEV: dbc_dict('hyundai_kia_generic', 'hyundai_kia_mando_front_radar'),
  CAR.SANTA_FE: dbc_dict('hyundai_kia_generic', 'hyundai_kia_mando_front_radar'),
  CAR.SANTA_FE_2022: dbc_dict('hyundai_kia_generic', 'hyundai_kia_mando_front_radar'),
  CAR.SONATA: dbc_dict('hyundai_kia_generic', 'hyundai_kia_mando_front_radar'),
  CAR.SONATA_LF: dbc_dict('hyundai_kia_generic', 'hyundai_kia_mando_front_radar'), # Has 0x5XX messages, but different format
  CAR.PALISADE: dbc_dict('hyundai_kia_generic', 'hyundai_kia_mando_front_radar'),
  CAR.VELOSTER: dbc_dict('hyundai_kia_generic', 'hyundai_kia_mando_front_radar'),
  CAR.KIA_CEED: dbc_dict('hyundai_kia_generic', 'hyundai_kia_mando_front_radar'),
