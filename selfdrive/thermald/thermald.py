...
def thermald_thread():
  ...
  while True:
    ...
    gitpullrun = params.get_bool("DoGitPull")
    ...
    elif os.path.isfile(prebuiltfile) and prebuiltlet and is_openpilot_dir and gitpullrun:
      os.system("cd /data/openpilot; git pull; rm -f prebuilt")
      HARDWARE.reboot()
